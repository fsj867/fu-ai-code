...
import com.fu.fuaicode.manager.CosManager;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        // 1. 生成本地截图
        String localScreenshotPath = webScreenshotUtils.takeScreenshotAsync(webUrl).join();
    ...
    private String uploadScreenshotToCos(String localScreenshotPath) {
        ...
        return cosManager.uploadFileAndGetUrl(cosKey, screenshotFile);
    }
